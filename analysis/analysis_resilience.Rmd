...
# Model 
```{r}
mod1 <- aov(rs~elev + clu_pop + elev:clu_pop, data=eviresi_f) 
...
adjustedMeans <- allEffects("clu_pop", mod1)
plot(Effect("clu_pop",mod1))


ph <- glht(mod1, linfct=mcp(clu_pop = "Tukey"))
summary(ph)
