...
# --- 
# 2005 
aux_spatial <- anom_sp[anom_sp$y ==2005,]
# raster auxiliar 
aux_rast <- raster(aux_spatial, resolution=250)
# raster_layer 
a2005 <- rasterize(aux_spatial, aux_rast, 'anomaly', fun=mean)
names(a2005) <- 'anomaly_2005' 
a2005 <- projectRaster(a2005, crs=CRS("+init=epsg:4326"))


# --- 
# 2012 
aux_spatial <- anom_sp[anom_sp$y ==2012,]
# raster auxiliar 
aux_rast <- raster(aux_spatial, resolution=250)
# raster_layer 
a2012 <- rasterize(aux_spatial, aux_rast, 'anomaly', fun=mean)
names(a2012) <- 'anomaly_2012' 
# reproject
a2012 <- projectRaster(a2012, crs=CRS("+init=epsg:4326"))


# Create stack of raster 
stack_a <- stack(a2005, a2012) 
```
